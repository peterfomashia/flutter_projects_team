    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          preferredSize: Size.fromHeight(144.0), // Height for AppBar + TabBar + Button + Dropdown
          child: Column(
            children: [
              TabBar(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(wordCount.toString(), style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ],
          ),
        ],
      ),
